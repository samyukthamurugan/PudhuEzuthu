...
<nav class="bookMy-sidenav bookMy-card-2 bookMy-top bookMy-xlarge bookMy-animate-left" style="display:none;z-index:2;width:40%;min-width:300px" id="mySidenav">
  ...
  <a href="SubscriptionPage.jsp" onclick="bookMy_close()">Subscribe</a>
    <a href="AddCourierDetails.jsp" onclick="bookMy_close()">Add Courier Details</a>
  <a href="ViewCourierDetails.jsp" onclick="bookMy_close()">View Courier Details</a>
<a href="#about" onclick="bookMy_close()">About</a><a href="LogOutServlet" onclick="bookMy_close()">Log out</a>
</nav>
