...
import java.util.List;import com.xbbnhfk.profile.ConnectionManager;
public class CartDao {
	public ArrayList<CartBean> viewCart(String email)
		{
		...
		ArrayList<CartBean> viewList = null;

			String viewQuery="select * from T_XBBNHFK_CART where email_id=?";
			...
			try
			{
				 ...
				 viewList = new ArrayList<CartBean>();
	...
	//ProfileBean proBean=pbean;
		...
		public void createProfile(ProfileBean profileBean)
